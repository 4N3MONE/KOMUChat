...
def model_init(args):
        ...
        # model_name = 'paust/pko-t5-base' #'paust/pko-t5-large'
...
if __name__ == '__main__':
        ...
        parser.add_argument('--qpath', default='./qlist.csv', type=str,
                                                help='question list')
        ...
        # if you want to get a answer list from question file
